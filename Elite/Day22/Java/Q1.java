// package Elite.Day22.Java;

// public Imagine a mystical garden with eight enchanted flower beds arranged in a straight 
...
class Q1{
    public static void main(String[] args){
        ...
        for(int j = 0; j < day; j++){
            temp[0] = 0;
            temp[7] = 0;
            for(int i = 1; i < 7; i++) temp[i] = 1 - (nums[i-1] ^ nums[i+1]);
            for(int i = 0; i < 8; i++) nums[i] = temp[i];
        }
