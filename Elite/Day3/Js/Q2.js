...
function fetchAvailableMovies() {
  ...
  async function processBooking(userId) {
    ...
    const [fetchMovie, checkDetails] = await Promise.all([fetchAvailableMovies(), checkUserDetails(userId)]);
  //   console.log(fetchMovie);
    console.log(checkDetails);
    
    // Sequential Activities: Choose movie and select showtime
    const choose = await chooseMovie(fetchMovie);
    console.log(choose);
    const select = await selectShowtime("Movie A");
    console.log(select);
