package Java;
// public In an Intelligence Agency, each senior officer supervises either two junior officers 
...
//         if(root.left != null){
//             left = root.left.val;
//             if(left == root.val) left = solve(root.left);
//         }
//         if(root.right!= null){
//             right = root.right.val;
//             if(right == root.val) right = solve(root.right);
//         }
